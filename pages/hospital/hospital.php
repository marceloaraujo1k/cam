...
<body>
    ...
    <!-- INCLUSÃO DO ARQUIVO MENU -->
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Hospitais/Clínicas</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
					    ...
					    <button class="btn btn-primary" data-toggle="modal" data-target="#modalUsuario">Inserir Hosp./Clínica</button>
						</div>
						 <div class="col-lg-10">
						</div>
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h4 class="modal-title" id="myModalLabel">Inserir Hospital/Clínica</h4>
									</div>
									<div class="modal-body">
								 <form role="form" action="./sqlHospital.php" method='post' enctype="multipart/form-data">
...
<!--  IMPORT PARA UTILIZACAO DOS BOTES DE IMPRIMIR, EXPORTAR EM CSV, PDF, EXCEL -->
	...
	<script>
		$(document).on('click','#btnExcluir',function(e){
            e.preventDefault();
		var id = $(this).data('id');
		 confirm("Excluir HOSPITAL ? " +id);
		location.assign("deleteHospital.php?id="+id);
		});
	</script>	
	...
	<script>
        ...
        e.preventDefault();
		var id = $(this).data('id');
		confirm("Editar HOSPITAL ? " +id);

		var xmlhttp = new XMLHttpRequest();
		xmlhttp.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
		var result = JSON.parse(this.responseText);
		document.getElementById("idhospital").value = id;
		document.getElementById("hospital").value = result[0][1];
		document.getElementById("cnpj").value = result[0][2];
		document.getElementById("endereco").value = result[0][3];
		}
		
		};
		xmlhttp.open("GET", "operacoes_hospital.php?id="+id, true);
		xmlhttp.send();
		$("#modalUsuario").modal();
		});
	...
	$('[data-dismiss=modal]').on('click', function (e) {
		...
		document.getElementById("idhospital").value = null;
