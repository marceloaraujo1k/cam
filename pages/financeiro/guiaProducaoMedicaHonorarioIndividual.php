    ...
    <div class="modal fade" id="modalGuiaProducaoMedica" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
								...
								<div class="form-group col-md-3">
											...
											<div class="form-group col-md-6">
												<label for="nome">Nome Contratado</label>
													<input class="form-control" type="text" name="nomeContratadoExecutante" id="nomeContratadoExecutante">
											</div>	
						...
						<!--			<div class="row">
												...
												<div class='input-group date' id='dtBxRealizacaoGuia'>
													<input type='text' class="form-control" name="dtBaixaRealizacaoGuia" id="dtBaixaRealizacaoGuia"/>
													<span class="input-group-addon">
													<span class="glyphicon glyphicon-calendar"></span>
													</span>
													</div>
										...
										<div class="form-group col-md-3">
											...
											<input class="form-control" type="text" name="codProcedimentoGuia" id="codProcedimentoGuia">
										</div>
									<div class="form-group col-md-6">
										<label for="nome">Descrição</label>
										<input class="form-control" type="text" name="descProcedimentoGuia" id="descProcedimentoGuia">
									</div>	
							</div>
