						...
						<div class="row"> 
							...
							<div class="row">
									...
									<div class="form-group col-lg-3">
										...
										<button type="button" class="btn btn-primary" id="btnModalGuia">Guia</button>
									...
									<div class="row">
											...
											<div class="form-group col-md-3">
												...
												<div class='input-group date' id='dtAssinaturaBeneficiario'>
													<input type='text' class="form-control" name="dtAssinaturaBeneficiario" id="dtAssinaturaBeneficiario"/>
													<span class="input-group-addon">
													<span class="glyphicon glyphicon-calendar"></span>
													</span>
												</div>
...
<script>
			...
			$.ajax({  
				...
				data: {submit : $("#inserirConta").val(), idproducao: $("#idproducao").val(), idempresa : $("#idempresa").val(),  dataRealizacao : $("#dataRealizacao").val(), idpaciente: $("#idpaciente").val(), paciente: $("#searchPaciente").val(), 
					  ...
					  valorRecebidoAnt : $('#valorRecebidoAnt').val(), observacao: observacao, medicoCirurgiao: medicoCirurgiao,
					  ...
					  atendimentoRN : $("#atendimentoRN").is(':checked'),
					  codCNES : $("#codCNES").val(), 
					  codigoContratadoExecutante : $("#codigoContratadoExecutante").val(), 
					  nomeContratadoExecutante : $("#codigoContratadoExecutante").val(), 
	...
	<script>
			...
			e.preventDefault();
				...
				data: {submit : $("#inserirConta").val(), idproducao: $("#idproducao").val(), idempresa : $("#idempresa").val(),  dataRealizacao : $("#dataRealizacao").val(), idpaciente: $("#idpaciente").val(), paciente: $("#searchPaciente").val(), 
					  ...
					  observacao: $("#observacao").val(), medicoCirurgiao: $("#medicoCirurgiao").val(),
					  tipoGuia: $("#tipoGuia").val(),
					  numeroGuia: $("#numeroGuia").val(),
					  guiaPrincipal: $("#guiaPrincipal").val(),
					  dataAutorizacao : $("#dataAutorizacao").val(),
