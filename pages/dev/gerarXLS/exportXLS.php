...
// Exibe a tabela 
$query = mysqli_query($mysql_conn, "SELECT * FROM  producao where idproducao=35953");
...

{
	...
	$dadosXls .= "<td>".$form["paciente"]."</td>";
	$dadosXls .= "<td>".$form["carteiraPaciente"]."</td>";
	$dadosXls .= "<td>".$form["medico"]."</td>";
	$dadosXls .= "<td>".$form["convenio"]."</td>";
	$dadosXls .= "<td>".$form["hospital"]."</td>";
	$dadosXls .= "<td>".$form["codigoProcedimento"]."</td>";
	$dadosXls .= "<td>".$form["descricaoProcedimento"]."</td>";
	//12
	$dadosXls .= "<td>".$form["valorProcedimento"]."</td>";
	$dadosXls .= "<td>".$form["quantidade"]."</td>";
	$dadosXls .= "<td>".$form["adicional"]."</td>";
	$dadosXls .= "<td>".$form["redutor"]."</td>";
	$dadosXls .= "<td>".$form["valorRecebido"]."</td>";
	$dadosXls .= "<td>".$form["glosa"]."</td>";
	...
	$dadosXls .= "<td>".$form["observacao"]."</td>";
	$dadosXls .= "<td>".$form["medicoCirurgiao"]."</td>";
   //29
...
// Configurações header para forçar o download
/*eader ("Expires: Mon, 26 Jul 1997 05:00:00 GMT");
