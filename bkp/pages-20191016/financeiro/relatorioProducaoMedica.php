...
$pdf->SetFillColor(8,172,192);
			...
			$pdf->Cell(100,5,''.utf8_decode(""),1,0,"L");
			...
			$pdf->Cell(160,5,''.utf8_decode("R$ TOTAL DOS PLANTÕES"),1,0,"L");
			$pdf->Cell(30,5,''.utf8_decode("R$  "),1,0,"L");
			$pdf->Cell(30,5,''.utf8_decode(" "),1,0,"L");
			$pdf->Cell(30,5,''.utf8_decode("R$  "),1,0,"L");
			$pdf->Cell(30,5,''.utf8_decode("R$  "),1,1,"L");
...
$pdf->SetWidths(array(18,18,60,20,45,25,15,15));
