													...
													<tbody>
													   <?php
														...
														<tr style="cursor:pointer">
															...
															<td><button type="button" id="btnPorte" class="btn btn btn-primary" data-id=<?=$form["idconvenio"]?> > <i class="glyphicon glyphicon-th-list">&nbsp;</i>Porte</button></td>
															<td><button type="button" id="btnProcedimentos" class="btn btn btn-primary" data-id=<?=$form["idconvenio"]?> > <i class="glyphicon glyphicon-list-alt">&nbsp;</i>Procedimentos</button></td>
														</tr>
														<?php
															}
   ...
   <script src="../../vendor/bootstrap/js/bootstrap.min.js"></script> 
	...
	<script>
		...
		window.open("procedimentos.php?id="+id,"procedimentos");
			...
			<script>
		$(document).on('click','#btnPorte',function(e){
            e.preventDefault();
		var id = $(this).data('id');
		window.open("porte.php?id="+id,"porte");
		});
		</script>
