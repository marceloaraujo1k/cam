...
$result_user = "SELECT COUNT(statusAtendimento) AS totalAgendado, MONTH(dataInicio) AS mes, dataInicio FROM clinise.agendamentos WHERE statusAtendimento='AGENDADO' GROUP BY MONTH(dataInicio) ORDER BY mes DESC LIMIT 3";
