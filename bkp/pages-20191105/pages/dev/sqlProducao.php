...
/*		if(!empty($_POST["nome"])) {
		...
		$query	= "INSERT INTO producao (idproducao, idempresa, paciente, dataRealizacao) VALUES (null, '$form[idempresa]', '$form[paciente]', STR_TO_DATE('$form[dataRealizacao]', '%d/%m/%Y %H:%i:%s' ))";
