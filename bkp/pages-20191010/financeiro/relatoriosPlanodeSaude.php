...
$pdf->ln();
	$pdf->SetFillColor(0,176,240);
			...
			$pdf->Cell(68,10,''.utf8_decode("Resumo dos plantões"),1,0,"L");
			$pdf->Cell(30,10,''.utf8_decode("Mês"),1,0,"L");
			$pdf->Cell(20,10,''.utf8_decode("Qtd."),1,0,"L");
			$pdf->Cell(30,10,''.utf8_decode("R$ bruto"),1,0,"L");
			$pdf->Cell(20,10,''.utf8_decode("% Imp."),1,0,"L");
			$pdf->Cell(30,10,''.utf8_decode("R$ Líquido"),1,1,"L");
			$pdf->Cell(68,5,''.utf8_decode(" "),1,0,"L");
		...
		$pdf->Cell(68,5,''.utf8_decode(" "),1,0,"L");
			...
			$pdf->Cell(118,10,''.utf8_decode("R$ Total dos plantões"),1,0,"L");
...
$pdf->cell(40,5,utf8_decode("PLANO DE SAÚDE"),1,0,'C',true);
$pdf->SetFillColor(92,184,92);
$pdf->cell(39,5,"SUS",1,0,'C',true);
$pdf->SetFillColor(240,173,78);
$pdf->cell(39,5,"ELETIVAS",1,0,'C',true);
$pdf->SetFillColor(217,83,79);
$pdf->cell(40,5,"PARTICULAR",1,1,'C',true);
$pdf->cell(40,5,utf8_decode("BRUTO/"),1,1,'C',false);
$pdf->cell(40,5,utf8_decode("RECEBIDO NF"),1,0,'C',false);	
